...
export default function Settings() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Settings updated', { name, email, oldPassword, newPassword });
  };
      ...
      <main style={styles.main}>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <div style={styles.inputGroup}>
            ...
            >
              {showOldPassword ? <FiEyeOff style={styles.iconSize} /> : <FiEye style={styles.iconSize} />}
            </button>
          </div>
          <div style={styles.inputGroup}>
            <RiLockPasswordLine style={styles.inputIcon} />
            ...
            <button
              ...
              style={styles.showPasswordButton}
            >
              {showNewPassword ? <FiEyeOff style={styles.iconSize} /> : <FiEye style={styles.iconSize} />}
            </button>
          </div>
